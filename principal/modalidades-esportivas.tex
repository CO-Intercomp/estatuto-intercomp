...
\begin{article}
	As inscrições dos atletas poderão ser feitas com o jogo já iniciado, em todos os esportes, com exceção do Xadrez, Tênis de Mesa, Tênis e de partidas interrompidas até o fim do primeiro tempo/set, conforme art. \ref{art:jogos.interromp}\ulo, sendo este artigo soberano às regras das federações.
\end{article}
