...
\begin{article}
	A Comissão Organizadora da \textbf{INTERCOMP} deverá ser composta pelas entidades integrantes.
...
\begin{article}
	...
	\begin{xparagraph}
		É de responsabilidade da presidência garantir que ocorra uma reunião para discutir a organização da próxima \textbf{INTERCOMP} no máximo 3 (três) meses após o término da última edição. Caso isso não ocorra, a presidência da última edição deverá pagar uma dívida de 1/2 (meio) salário mínimo.
...
\begin{article}
	Em no máximo um mês após o término da \textbf{INTERCOMP}, a Comissão Organizadora deverá se reunir para a apresentação de um relatório técnico, apreciação do balanço financeiro apresentado pelo financeiro.
