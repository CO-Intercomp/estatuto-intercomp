...
\begin{article}
	Cada participante poderá inscrever no máximo 4 (quatro) atletas por confronto de Tênis, devendo indicar, antes do sorteio de emparceiramentos, 2 (dois) atletas para disputar as partidas simples - sendo que apenas 1 (um) pode ter se formado em 2018 ou 2019 e/ou ser aluno de um de seus cursos não estatutários - e 2 (dois) atletas para disputar a partida de duplas - sendo que apenas 1 (um) pode estar formado e/ou ser aluno de um de seus cursos não estatutários. Os atletas indicados para disputar as partidas simples serão sorteados no emparceiramento, sendo denominados Atleta A ou Atleta B
