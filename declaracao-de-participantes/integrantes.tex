...
\begin{article}
	...
	\begin{description}[noitemsep]
		...
		\begin{itemize}[noitemsep]
			...
			\item Bacharelado em Engenharia de Produção  \textbf{\textit{(não estatutário)}}
			\item Bacharelado em Engenharia de Materiais  \textbf{\textit{(não estatutário)}}
			\item Bacharelado em Engenharia Elétrica  \textbf{\textit{(não estatutário)}}
			\item Licenciatura em Física
			\item Licenciatura em Matemática
		...
		\begin{itemize}[noitemsep]
			...
			\item Bacharelado em Biotecnologia
			\item Bacharelado em Gestão Ambiental
